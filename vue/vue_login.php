...
<div class="vr border-3 border border-dark rounded-4 p-0"></div>
        ...
        <div class="col-md-6">
          <form action="#" method="post">
            ...
            <?php endif; ?>
            <div class="form-floating mb-3">
              <input type="text" class="form-control" name="nom" id="floatingInput" placeholder="name@example.com">
              <label for="floatingInput">Nom</label>
            </div>
            <div class="form-floating mb-3">
              <input type="text" class="form-control" name="prenom" id="floatingPassword" placeholder="Password">
